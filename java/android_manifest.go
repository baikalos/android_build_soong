...
func ManifestFixer(ctx android.ModuleContext, manifest android.Path,
	...
	if params.SdkContext != nil {
		...
		if useApiFingerprint, fingerprintTargetSdkVersion, fingerprintDeps :=
			UseApiFingerprint(ctx); useApiFingerprint && ctx.ModuleName() != "framework-res" && ctx.ModuleName() != "org.lineageos.platform-res" && ctx.ModuleName() != "org.mineageos.platform-res" {
